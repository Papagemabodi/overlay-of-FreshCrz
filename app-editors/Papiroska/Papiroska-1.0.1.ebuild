...
DESCRIPTION="CLI Image wiever"

# Homepage, not used by Portage directly but handy for developer reference
HOMEPAGE="https://github.com/Papagemabodi/Papiroska"

# Point to any required sources; these will be automatically downloaded by
# Portage.
SRC_URI="https://gitlab.com/Papagemabodi/Papiroska/-/archive/v${PV}/Papiroska-v${PV}.tar.gz -> ${P}.tar.gz"
...
src_compile() {
	zig build-exe papiroska.zig -O ReleaseSafe -target native-native -mcpu=native -static || die "Build failure"
}
