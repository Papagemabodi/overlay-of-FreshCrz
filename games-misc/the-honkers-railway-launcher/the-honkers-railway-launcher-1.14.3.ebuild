...
DESCRIPTION="Honkers railway game launcher binary ebuild"
...
# Portage.
SRC_URI="https://github.com/an-anime-team/the-honkers-railway-launcher/releases/download/${PV}/honkers-railway-launcher"
...
# you only need to call it, if you need different behaviour.
src_install() {
    dobin "${DISTDIR}/honkers-railway-launcher"
